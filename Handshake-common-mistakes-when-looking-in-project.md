...
Sense of Tor is anonymous access to network, while if we anyways pass all the data to our DNS providers, tor becomes useless for us. So .onion integration with DNS providers is absolutely useless: Sense is lost.
...
There's unregistred good domain, a.com for example. You know it and realize its potential. I don't know what would exactly you do, maybe just leave it because "Maybe some dev will come and use it later... Will leave it for him!", but I would just buy this name (I am not dumbie and I understand value of it, I will resell it later).
